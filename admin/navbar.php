                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                ...
                                <li>
                                    <a href="index2.html">View Posts</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a href="chart.html">
                                <i class="fas fa-chart-bar"></i>test</a>
                        </li>
                        <li>
                            <a href="table.html">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="button.html">gggggggggggg</a>
                                </li>
                                <li>
                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="active has-sub">
                            ...
                            <li>
                                    <a href="new_post.php">Blog Header</a>
                                </li>

                                <li>
                                    <a href="portfolio.php">Portfolio Section</a>
                                </li>
